...
import me.coderfrish.ankair.util.PositionUtil;
...
public class PacketBuffer extends ByteBuf {
    ...
    public PacketBuffer writeString(String value) {
        return this.writeString(value, 32767);
    }
    ...
    public PacketBuffer writeString(String value, int length) {
    ...
    public BlockPosition readPosition() {
        return PositionUtil.of(this.readLong());
    }

    public PacketBuffer writePosition(BlockPosition position) {
        writeLong(PositionUtil.to(position));
        return this;
    }
